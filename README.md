# Sophic Internship Prep

15-day intensive web-skills sprint for the **Sophic Automation IT Support internship**.
5 hours/day · 75 hours total. Starting from Java + some Python, zero web experience.

**Rule:** type every line myself, commit every single day, break things on purpose.
...
MDN Web Docs — https://developer.mozilla.org — the only reference that matters.
